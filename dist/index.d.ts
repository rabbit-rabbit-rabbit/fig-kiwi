declare module 'fig-kiwi/archive' {
  export type Header = {
      prelude: string;
      version: number;
  };
...
declare module 'fig-kiwi/archive.test' {
  export {};

}
declare module 'fig-kiwi/fig-kiwi' {
  export type MessageType = "JOIN_START" | "NODE_CHANGES" | "USER_CHANGES" | "JOIN_END" | "SIGNAL" | "STYLE" | "STYLE_SET" | "JOIN_START_SKIP_RELOAD" | "NOTIFY_SHOULD_UPGRADE" | "UPGRADE_DONE" | "UPGRADE_REFRESH" | "SCENE_GRAPH_QUERY" | "SCENE_GRAPH_REPLY" | "DIFF" | "CLIENT_BROADCAST";
  export type Axis = "X" | "Y";
  export type Access = "READ_ONLY" | "READ_WRITE";
  export type NodePhase = "CREATED" | "REMOVED";
  export type WindingRule = "NONZERO" | "ODD";
  export type NodeType = "NONE" | "DOCUMENT" | "CANVAS" | "GROUP" | "FRAME" | "BOOLEAN_OPERATION" | "VECTOR" | "STAR" | "LINE" | "ELLIPSE" | "RECTANGLE" | "REGULAR_POLYGON" | "ROUNDED_RECTANGLE" | "TEXT" | "SLICE" | "SYMBOL" | "INSTANCE" | "STICKY" | "SHAPE_WITH_TEXT" | "CONNECTOR" | "CODE_BLOCK" | "WIDGET" | "STAMP" | "MEDIA" | "HIGHLIGHT" | "SECTION" | "SECTION_OVERLAY" | "WASHI_TAPE" | "VARIABLE";
  export type ShapeWithTextType = "SQUARE" | "ELLIPSE" | "DIAMOND" | "TRIANGLE_UP" | "TRIANGLE_DOWN" | "ROUNDED_RECTANGLE" | "PARALLELOGRAM_RIGHT" | "PARALLELOGRAM_LEFT" | "ENG_DATABASE" | "ENG_QUEUE" | "ENG_FILE" | "ENG_FOLDER";
  ...
  export type StrokeCap = "NONE" | "ROUND" | "SQUARE" | "ARROW_LINES" | "ARROW_EQUILATERAL" | "DIAMOND_FILLED" | "TRIANGLE_FILLED" | "HIGHLIGHT" | "WASHI_TAPE_1" | "WASHI_TAPE_2" | "WASHI_TAPE_3" | "WASHI_TAPE_4" | "WASHI_TAPE_5" | "WASHI_TAPE_6" | "CIRCLE_FILLED";
  ...
  export type MouseCursor = "DEFAULT" | "CROSSHAIR" | "EYEDROPPER" | "HAND" | "PAINT_BUCKET" | "PEN" | "PENCIL" | "MARKER" | "ERASER" | "HIGHLIGHTER";
  ...
  export type StyleSetType = "PERSONAL" | "TEAM" | "CUSTOM" | "FREQUENCY" | "TEMPORARY";
  export type StyleSetContentType = "SOLID" | "GRADIENT" | "IMAGE";
  export type StackMode = "NONE" | "HORIZONTAL" | "VERTICAL";
  export type StackAlign = "MIN" | "CENTER" | "MAX" | "BASELINE";
  export type StackCounterAlign = "MIN" | "CENTER" | "MAX" | "STRETCH" | "AUTO" | "BASELINE";
  export type StackJustify = "MIN" | "CENTER" | "MAX" | "SPACE_EVENLY";
  export type StackSize = "FIXED" | "RESIZE_TO_FIT" | "RESIZE_TO_FIT_WITH_IMPLICIT_SIZE";
  export type StackPositioning = "AUTO" | "ABSOLUTE";
  export type ConnectionType = "NONE" | "INTERNAL_NODE" | "URL" | "BACK" | "CLOSE" | "SET_VARIABLE";
  export type InteractionType = "ON_CLICK" | "AFTER_TIMEOUT" | "MOUSE_IN" | "MOUSE_OUT" | "ON_HOVER" | "MOUSE_DOWN" | "MOUSE_UP" | "ON_PRESS" | "NONE" | "DRAG" | "ON_KEY_DOWN" | "ON_VOICE";
  export type TransitionType = "INSTANT_TRANSITION" | "DISSOLVE" | "FADE" | "SLIDE_FROM_LEFT" | "SLIDE_FROM_RIGHT" | "SLIDE_FROM_TOP" | "SLIDE_FROM_BOTTOM" | "PUSH_FROM_LEFT" | "PUSH_FROM_RIGHT" | "PUSH_FROM_TOP" | "PUSH_FROM_BOTTOM" | "MOVE_FROM_LEFT" | "MOVE_FROM_RIGHT" | "MOVE_FROM_TOP" | "MOVE_FROM_BOTTOM" | "SLIDE_OUT_TO_LEFT" | "SLIDE_OUT_TO_RIGHT" | "SLIDE_OUT_TO_TOP" | "SLIDE_OUT_TO_BOTTOM" | "MOVE_OUT_TO_LEFT" | "MOVE_OUT_TO_RIGHT" | "MOVE_OUT_TO_TOP" | "MOVE_OUT_TO_BOTTOM" | "MAGIC_MOVE" | "SMART_ANIMATE" | "SCROLL_ANIMATE";
  export type EasingType = "IN_CUBIC" | "OUT_CUBIC" | "INOUT_CUBIC" | "LINEAR" | "IN_BACK_CUBIC" | "OUT_BACK_CUBIC" | "INOUT_BACK_CUBIC" | "CUSTOM_CUBIC" | "SPRING" | "GENTLE_SPRING" | "CUSTOM_SPRING" | "SPRING_PRESET_ONE" | "SPRING_PRESET_TWO" | "SPRING_PRESET_THREE";
  ...
  export type StyleType = "NONE" | "FILL" | "STROKE" | "TEXT" | "EFFECT" | "EXPORT" | "GRID";
  export type ScrollBehavior = "SCROLLS" | "FIXED_WHEN_CHILD_OF_SCROLLING_FRAME";
  export type ConnectorMagnet = "NONE" | "AUTO" | "TOP" | "LEFT" | "BOTTOM" | "RIGHT";
  export type ConnectorTextSection = "MIDDLE_TO_START" | "MIDDLE_TO_END";
  export type ConnectorLineStyle = "ELBOWED" | "STRAIGHT";
  export type EditorType = "DESIGN" | "WHITEBOARD";
  export type ComponentPropNodeField = "VISIBLE" | "TEXT_DATA" | "OVERRIDDEN_SYMBOL_ID" | "INHERIT_FILL_STYLE_ID";
  export type ComponentPropType = "BOOL" | "TEXT" | "COLOR" | "INSTANCE_SWAP";
  export type WidgetEvent = "MOUSE_DOWN" | "CLICK" | "TEXT_EDIT_END" | "ATTACHED_STICKABLES_CHANGED" | "STUCK_STATUS_CHANGED";
  export type WidgetInputBehavior = "WRAP" | "TRUNCATE" | "MULTILINE";
  export type WidgetPropertyMenuItemType = "ACTION" | "SEPARATOR" | "COLOR" | "DROPDOWN" | "COLOR_SELECTOR" | "TOGGLE" | "LINK";
  export type CodeBlockLanguage = "TYPESCRIPT" | "CPP" | "RUBY" | "CSS" | "JAVASCRIPT" | "HTML" | "JSON" | "GRAPHQL" | "PYTHON" | "GO" | "SQL" | "SWIFT" | "KOTLIN" | "RUST";
  export type InternalEnumForTest = "OLD";
  export type BulletType = "ORDERED" | "UNORDERED" | "INDENT" | "NO_LIST";
  export type LineType = "PLAIN" | "ORDERED_LIST" | "UNORDERED_LIST";
  export type Directionality = "LTR" | "RTL";
  export type DirectionalityIntent = "IMPLICIT" | "EXPLICIT";
  export type TriggerDevice = "KEYBOARD" | "UNKNOWN_CONTROLLER" | "XBOX_ONE" | "PS4" | "SWITCH_PRO";
  export type TransitionDirection = "FORWARD" | "REVERSE";
  export type PlaybackChangePhase = "INITIATED" | "ABORTED" | "COMMITTED";
  export type RichMediaType = "ANIMATED_IMAGE";
  export type VariableDataType = "BOOLEAN" | "FLOAT" | "STRING";
  export type HTMLTag = "AUTO" | "ARTICLE" | "SECTION" | "NAV" | "ASIDE" | "H1" | "H2" | "H3" | "H4" | "H5" | "H6" | "HGROUP" | "HEADER" | "FOOTER" | "ADDRESS" | "P" | "HR" | "PRE" | "BLOCKQUOTE" | "OL" | "UL" | "MENU" | "LI" | "DL" | "DT" | "DD" | "FIGURE" | "FIGCAPTION" | "MAIN" | "DIV" | "A" | "EM" | "STRONG" | "SMALL" | "S" | "CITE" | "Q" | "DFN" | "ABBR" | "RUBY" | "RT" | "RP" | "DATA" | "TIME" | "CODE" | "VAR" | "SAMP" | "KBD" | "SUB" | "SUP" | "I" | "B" | "U" | "MARK" | "BDI" | "BDO" | "SPAN" | "BR" | "WBR" | "PICTURE" | "SOURCE" | "IMG" | "FORM" | "LABEL" | "INPUT" | "BUTTON" | "SELECT" | "DATALIST" | "OPTGROUP" | "OPTION" | "TEXTAREA" | "OUTPUT" | "PROGRESS" | "METER" | "FIELDSET" | "LEGEND";
  export type ARIARole = "AUTO" | "BUTTON" | "CHECKBOX" | "GRIDCELL" | "LINK" | "MENUITEM" | "MENUITEMCHECKBOX" | "MENUITEMRADIO" | "OPTION" | "PROGRESSBAR" | "RADIO" | "SCROLLBAR" | "SEARCHBOX" | "SEPARATOR" | "SLIDER" | "SPINBUTTON" | "SWITCH" | "TAB" | "TABPANEL" | "TEXTBOX" | "TREEITEM" | "COMBOBOX" | "GRID" | "LISTBOX" | "MENU" | "MENUBAR" | "RADIOGROUP" | "TABLIST" | "TREE" | "TREEGRID" | "APPLICATION" | "ARTICLE" | "BLOCKQUOTE" | "CAPTION" | "CELL" | "COLUMNHEADER" | "DEFINITION" | "DELETION" | "DIRECTORY" | "DOCUMENT" | "EMPHASIS" | "FEED" | "FIGURE" | "GENERIC" | "GROUP" | "HEADING" | "IMG" | "INSERTION" | "LIST" | "LISTITEM" | "MATH" | "METER" | "NONE" | "NOTE" | "PARAGRAPH" | "PRESENTATION" | "ROW" | "ROWGROUP" | "ROWHEADER" | "STRONG" | "SUBSCRIPT" | "SUPERSCRIPT" | "TABLE" | "TERM" | "TIME" | "TOOLBAR" | "TOOLTIP" | "BANNER" | "COMPLEMENTARY" | "CONTENTINFO" | "FORM" | "MAIN" | "NAVIGATION" | "REGION" | "SEARCH" | "ALERT" | "LOG" | "MARQUEE" | "STATUS" | "TIMER" | "ALERTDIALOG" | "DIALOG";
...
declare module 'fig-kiwi/figdata' {
  import { Schema } from "kiwi-schema";
  import { Message, SparseMessage } from "fig-kiwi/schema-defs";
...
declare module 'fig-kiwi/figdata.test' {
  export {};

}
declare module 'fig-kiwi/fightml' {
...
declare module 'fig-kiwi/fightml.test' {
  export {};

}
declare module 'fig-kiwi/index' {
  import { FigmaMeta } from "fig-kiwi/fightml";
  import FigmaArchiveParser, { Header } from "fig-kiwi/archive";
  import { Schema } from "kiwi-schema";
...
declare module 'fig-kiwi/schema-defs' {
  export type MessageType = "JOIN_START" | "NODE_CHANGES" | "USER_CHANGES" | "JOIN_END" | "SIGNAL" | "STYLE" | "STYLE_SET" | "JOIN_START_SKIP_RELOAD" | "NOTIFY_SHOULD_UPGRADE" | "UPGRADE_DONE" | "UPGRADE_REFRESH" | "SCENE_GRAPH_QUERY" | "SCENE_GRAPH_REPLY" | "DIFF" | "CLIENT_BROADCAST";
  export type Axis = "X" | "Y";
  export type Access = "READ_ONLY" | "READ_WRITE";
  export type NodePhase = "CREATED" | "REMOVED";
...
declare module 'fig-kiwi/schema' {
  const _default: import("kiwi-schema").Schema;
  export default _default;

}
declare module 'fig-kiwi' {
  import main = require('fig-kiwi/index');
  export = main;
}